...
el número actual seguido de un guion 
(ej: "1 - 2 - 3 - ") al párrafo.*/
...
En cada iteración, agrega el nombre del estudiante al párrafo, 
...
suma 1 al contador. Al terminar el ciclo, muestra en el párrafo 
pantalla: "Total de alumnos aprobados: [número]".*/
...
function inventario() {
    let productos = ["Teclado", "Mouse", "Agotado", "Monitor", "Agotado", "Audífonos"];
    const container = document.getElementById('resultado-containercuatro');
...
Al finalizar el ciclo, escribe en el párrafo:
...
aumenta tu contador. Al final, inyecta en el párrafo: 
